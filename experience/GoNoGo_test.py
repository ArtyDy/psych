...
listecondition=['GB', 'NGB', 'NGD', 'GD']
listetemps=[0.2, 0.8, 0.5, 0.8]

####=>liste=['GB2', 'NGB8', 'NGD5', 'GD8'
...
filename='C:/Users/mathi/OneDrive/Documents/GitHub/psych/experience/'+ sub + '.mat'
